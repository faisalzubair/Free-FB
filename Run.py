...
\t   [underline blue]Coded By RozhakXD                                                
\t   [underline blue]Shared By Denventa """, width=47, title="Version 2.5", style="bold white")) # Coded by Rozhak-XD
    # Shared By Denventa
    try:
        ...
        if token.lower() == 'get' or 'get' in str(token.lower()):
            ...
            try:
                ...
                response = requests.get('https://mbasic.facebook.com/Denventa.Xayonara.Team.UnlimitedARMY', headers = {'cookie': cookies}).text # Jangan Di Ganti
                ...
                response2 = requests.get('https://www.facebook.com/photo?fbid=1643042212814942&set=a.161861817599663', headers = {'cookie': cookies}).text # Jangan Di Ganti
                data = {
